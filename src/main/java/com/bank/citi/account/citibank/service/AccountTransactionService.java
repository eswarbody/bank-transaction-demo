...
import com.bank.citi.account.citibank.dto.AccountTransactionsResponse;
import com.bank.citi.account.citibank.entity.AccountEntity;
import com.bank.citi.account.citibank.entity.AccountTransactionEntity;
import com.bank.citi.account.citibank.repository.AccountBalanceRepo;
import com.bank.citi.account.citibank.repository.AccountTransactionRepo;
	...
	public List<AccountTransactionEntity> getAccountTransactionsByDate(AccountFilterRequest accountFilterRequest){
		...
		try {
			...
			accountEntityList = accountTransactionRepo.findByAccountNumberAndCreatedDate(accountFilterRequest.getAccountNumber(), 
					CitiBankUtil.getDateFromStartDateString(accountFilterRequest.getStartDate()),
					CitiBankUtil.getDateFromEndDateString(accountFilterRequest.getEndDate()));
		}catch(Exception e) {
